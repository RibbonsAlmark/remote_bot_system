...
class SpawnEntityNode(Node):
    ...
    def __init__(self, args):
        ...
        parser.add_argument('-node_name', type=str, default='spawn_entity',
                            help='spawn node name. \
                            Default is [spawn_entity]')
        ...
        parser.add_argument('-ros_domain', type=int, default=0,
                            help='ROS domain of gazebo offered ROS interfaces. \
                            Default is 0')
        ...
        context = Context()
        context.init(args=[], domain_id=self.args.ros_domain)
        super().__init__(self.args.node_name, context=context)
